...
exports.config = {
  ...
  ###
  modules: ['lint', 'require', 'minify', 'live-reload', 'mimosa-karma']
  ...
  watch:
    ...
    javascriptDir: "scripts"       # Location of precompiled javascript (i.e.
  ...
  #server:                      # configuration for server when server option is enabled via CLI
    ...
    #path: 'tests/server.coffee'      # valid when defaultServer.enabled: false, path to file for provided
